...
**Status:** core and icon system extracted; notifications module extraction
still pending. The package is not yet installable — no `package.json` or
build tooling exists yet. See `docs/adr/0001-package-architecture.md` for
the architecture this repository is being built against, and
